...
public class UserGamificationController {
    ...
    public ResponseEntity<ApiResponse<UserGamificationProfile>> createOrGetUserProfile(@PathVariable Long userId) {
        log.info("Creating or getting profile for user {}", userId);
    ...
    public ResponseEntity<ApiResponse<UserGamificationProfile>> getUserProfile(@PathVariable Long userId) {
    ...
    public ResponseEntity<ApiResponse<UserGamificationProfile>> updateUserPoints(
        ...
        log.info("Updating points for user {} with {} points", userId, pointsToAdd);
    ...
    public ResponseEntity<ApiResponse<UserGamificationProfile>> updateUserStreak(
        ...
        log.info("Updating streak for user {} - type: {}, continues: {}",
    ...
    public ResponseEntity<ApiResponse<Integer>> getUserCurrentStreak(
        ...
        log.info("Getting current streak for user {} and type {}", userId, streakType);
    ...
    public ResponseEntity<ApiResponse<Integer>> getUserLongestStreak(
        ...
        log.info("Getting longest streak for user {} and type {}", userId, streakType);
    ...
    public ResponseEntity<ApiResponse<Long>> getUserPointsRank(@PathVariable Long userId) {
        log.info("Getting points rank for user {}", userId);
    ...
    public ResponseEntity<ApiResponse<Long>> getUserLevelRank(@PathVariable Long userId) {
        log.info("Getting level rank for user {}", userId);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getUserAchievementsSummary(@PathVariable Long userId) {
    ...
    public ResponseEntity<ApiResponse<LeaderboardResponse>> getStreakLeaderboard(
        ...
        log.info("Getting streak leaderboard for type {} with limit {}", streakType, limit);
    ...
    public ResponseEntity<ApiResponse<LeaderboardResponse>> getLongestStreakLeaderboard(
        ...
        log.info("Getting longest streak leaderboard for type {} with limit {}", streakType, limit);
    ...
    public ResponseEntity<ApiResponse<List<UserGamificationProfile>>> getUsersWithActiveStreak(
            @PathVariable String streakType) {
        log.info("Getting users with active streak of type {}", streakType);
    ...
    public ResponseEntity<ApiResponse<List<UserGamificationProfile>>> getUsersWithMinimumStreak(
        ...
        log.info("Getting users with minimum streak of {} for type {}", minLength, streakType);
